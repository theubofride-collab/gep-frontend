...
const INCIDENTS = [
  { id:1, nom:'Diallo Aïcha', matricule:'EP-2024-001', classe:'CM2-A', type:'Retard', gravite:'Faible', date:'12/04/2026 08:15', statut:'Traité', photo:null },
  { id:2, nom:'Sow Mamadou', matricule:'EP-2024-002', classe:'CM1-B', type:'Violence', gravite:'Grave', date:'18/04/2026 10:45', statut:'En cours', photo:null },
  { id:3, nom:'Ndiaye Fatou', matricule:'EP-2024-003', classe:'CE2-A', type:'Absence répétée', gravite:'Moyenne', date:'20/04/2026 08:00', statut:'En cours', photo:null },
  { id:4, nom:'Ba Ibrahima', matricule:'EP-2024-004', classe:'CM2-A', type:'Non-respect du règlement', gravite:'Moyenne', date:'22/04/2026 14:20', statut:'Traité', photo:null },
  { id:5, nom:'Faye Awa', matricule:'EP-2024-005', classe:'CE1-C', type:'Retard', gravite:'Faible', date:'25/04/2026 08:10', statut:'En cours', photo:null },
  { id:6, nom:'Sarr Ousmane', matricule:'EP-2024-006', classe:'CM1-A', type:'Violence', gravite:'Grave', date:'29/04/2026 11:00', statut:'En cours', photo:null },
];
                ...
                <tr key={inc.id}>
                  ...
                  <td>
                    <div className="actions">
                      <button className="icon-btn view" title="Voir">
            ...
            <div className="modal-body">
              ...
              <div className="fgroup">
                ...
                <select className="fselect" value={form.type} onChange={e=>setForm({...form,type:e.target.value})}>
                  ...
                  <option>Retard</option><option>Violence</option><option>Absence répétée</option>
                  <option>Non-respect du règlement</option><option>Autre</option>
                </select>
              </div>
              <div className="fgroup">
                <label>Gravité</label>
                <select className="fselect" value={form.gravite} onChange={e=>setForm({...form,gravite:e.target.value})}>
                  <option value="">Sélectionner...</option>
                  <option>Faible</option><option>Moyenne</option><option>Grave</option>
                </select>
              </div>
