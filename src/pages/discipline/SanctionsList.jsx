        ...
        <div className="overlay" onClick={()=>setShowModal(false)}>
          <div className="modal" onClick={e=>e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="fgroup"><label>Incident lié</label><select className="fselect" value={form.incident} onChange={e=>setForm({...form,incident:e.target.value})}><option value="">Sélectionner un incident...</option><option>Retard — Diallo Aïcha</option><option>Violence — Sow Mamadou</option><option>Absence répétée — Ndiaye Fatou</option></select></div>
              <div className="fgroup"><label>Type de sanction</label><select className="fselect" value={form.type} onChange={e=>setForm({...form,type:e.target.value})}><option value="">Sélectionner...</option><option>Avertissement</option><option>Retenue</option><option>Exclusion temporaire</option><option>Exclusion définitive</option></select></div>
